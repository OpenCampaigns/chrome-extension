document.addEventListener('DOMContentLoaded', () => {
    ...
    const excludedInput = document.getElementById('excludedTags') as HTMLInputElement;
    ...
    chrome.storage.sync.get(['oc_themes', 'oc_excluded_tags', 'oc_block_nsfw'], (result) => {
        ...
        if (result.oc_excluded_tags) excludedInput.value = result.oc_excluded_tags;
